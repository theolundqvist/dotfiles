...
binaryDic = dict(title=str(binary), subtitle="Binary of length: " + str(len(binary)) + ", %8 = " + str(len(binary)%8) , uid="binary", valid=True, arg=str(binary), icon="icons/binary.png")
